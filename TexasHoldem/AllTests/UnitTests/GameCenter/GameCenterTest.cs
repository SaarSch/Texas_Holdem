...
namespace AllTests.UnitTests.GameCenter
{
    ...
    public class GameCenterTest
    {
        ...
        public void GameCenter_SetLeagues_all_leagues_Odd()
        {
            ...
            var user = _u.First(u => u.Item1.Username == "aaaaaaa60").Item1;
            user.Wins = 60;
        ...
        {
            var succ = false;
            var mockr1 = createMockRoom("MyRoom1", "player1");
            var mockr2 = createMockRoom("MyRoom2", "player2");
        ...
        public void GameCenter_FindGames_PotAndPlayer()
        {
            ...
            var mockr1 = createMockRoom("MyRoom1", "player1");
            var mockr2 = createMockRoom("MyRoom2", "player2");
            var mockr3 = createMockRoom("MyRoom3", "player2");
            _gc.Rooms.Add(mockr1);
            _gc.Rooms.Add(mockr2);
